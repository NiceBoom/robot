...
public class FlyBookConfig {
    ...
    //获取tenant_access_token 代码
    public static final String GET_FLYBOOK_TENANT_ACCESS_TOKEN = "tenant_access_token";
    //获取app_access_token 代码
    public static final String GET_FLYBOOK_APP_ACCESS_TOKEN = "app_access_token";
    //获取user_access_token 代码
